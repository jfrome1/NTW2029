...
**1.1.3. Computing duration (Reliable, but uncertain if Scenario 2 applies)**
...
**1.2.3. Computing duration (Approximate, biased high)**
...
**1.3.3. Computing duration (Reliable [for total duration])**
...
**1.4.3. Computing duration (Reliable)**
...
- This method only becomes less reliable if estimating student study sessions is needed.  
...
**1.5.3. Computing duration (Reliable [for total duration])**
...
**1.6.3. Computing duration (reliable)**
