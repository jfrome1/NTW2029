...
- consider an analogy: astronomers can explain how the planets orbit each other, and we discovered the mechanisms such as gravity that govern planetary orbits relatively recently, but accepting the theory of gravity does not mean that you reject the notion that God created the universe
...
1. You might say that the science is wrong, the earth is young, and evolution is false. This is extremely difficult to do, because the scientific evidence for evolution is really overwhelming (see resource page [Questions about Evolution](/course-ntw2029/resources/questions-about-evolution))
