...
- Many students this time seem to include almost obviously confusing parts Their first draft. I need to make clear that they should try their best to make it clear and specific and they shouldn't write a first draft and not revise anything. The aspects of the second part shouldn't be obvious things that you would normally go back and fix they should identify things you tried to make clear but you still recognize might be confusing to someone.
- Must specify that they should use a live in person reader and should not accept reader feedback sent back to them through Telegram or some other format. The feedback sent via messaging was usually really short and unclear in itself.
- clarify that in this class, academic writing doesn't use bold or italics for emphasis (with limited exceptions), emojis, arrows, bullet points, or exclamation points.
- Add a brief assessment of how your predictions matched or did not match your readers' confusion
- Make clear that your readers job is to read this and then evaluate whether they could actually do it, they're not supposed to be reading it like a teacher or like a peer reviewer giving feedback. Maybe I should actually have the student describe something that their friend could actually do and see if the friend can do it based on the explanation.
- Even though it's credit no credit in my mind I'm going to be evaluating it based on whether a person could actually do the thing you're describing correctly based on your explanation
-
...
Do not include a typical essay introduction or conclusion for this exercise, but do briefly orient your reader by providing context for your explanation. Why would they want to learn how to do this thing? Set the context, explain how to do the thing, and end briefly with any useful final information.

Start with a title that makes clear what you will explain.
