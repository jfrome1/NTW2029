...
- **Analytical thesis** identifying what makes these positions incompatible—different definitions, assumptions, standards for evidence, or interpretations
- **Analysis** supporting your thesis with specific evidence and reasoning
- **Significance discussion** explaining what your analysis contributes to the academic conversation

*For detailed guidance on developing analytical theses and understanding what distinguishes stronger analysis, see the P07 and P09 assignment pages.*
...
- **P07: Working Draft** (Week 11) - Add analytical thesis about incompatibility and supporting analysis (1200-1500 words, peer review)
...
See individual assignment pages for detailed instructions. P07 provides guidance on developing analytical theses about incompatibility. P09 contains the assessment framework and examples of what distinguishes stronger analysis.
...
Your analytical thesis should **emerge from your analysis** of the disagreement, not precede it. You cannot know what makes positions incompatible until you've carefully analyzed both positions and what drives their different conclusions.

For example:

**Analytical thesis (appropriate):** "The target's definition excludes cases the commentary presents, revealing a gap in what the theory can explain."

**Evaluative thesis (save for later):** "I agree with the commentary because their position makes more sense."

The first identifies what makes positions incompatible through analysis. The second chooses sides without demonstrating why. P07 focuses on the analytical work; P08-P09 is where you might include evaluation if your analysis supports it.

### Structure

All papers should include:

- **Introduction** - Orient reader to the disagreement and state your analytical thesis
...
- **Significance discussion** - What your analysis contributes to the academic conversation
...
A claim about what makes the positions incompatible, not an evaluation of which is stronger. Your thesis should identify what drives the disagreement—different definitions, assumptions, methodological commitments, or interpretations. See P07 for examples and detailed guidance.

**Am I supposed to pick a side?**
Not required. P07 focuses on understanding what makes positions incompatible. In P08-P09, you may include evaluation if your analysis supports it, but the core task throughout is understanding incompatibility.
...
Each assignment builds specific skills: P04 focuses selection, P05 maps disagreement structure and verifies significance, P06 develops neutral explanation, P07 adds analytical thesis about incompatibility, P08 adds required significance discussion and sources.
...
All papers must include all core components (explanation, analytical thesis about incompatibility, supporting analysis, significance discussion). Deeper analysis means more sophisticated insights about what drives incompatibility, not additional sections. P07 and P09 provide frameworks for understanding depth.

**How can I strengthen my analysis?**
Stronger analysis often addresses questions like: What theoretical goals make different approaches useful? What would it take to resolve this disagreement? How do methodological commitments constrain conclusions? What's gained and lost with each position? See P09 for detailed guidance.
