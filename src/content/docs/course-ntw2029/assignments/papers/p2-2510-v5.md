...
- **Significance:** Discuss one specific consequence from the identified difference—be concrete by naming what becomes difficult, unclear, or unresolvable
...
All papers must include all core components—what distinguishes grades is the depth and sophistication with which you answer core questions about the disagreement. See P09 for details on assessment.
