...
5. In a list or outline form, state brief summaries of the reasons and evidence (if any) supporting the claim, as well as any important assumptions the claim relies on. The list is a way to think of the claim as the logical conclusion of premises in an argument. Items 4 and 5 are intentionally redundant; I'm asking you to express the argument in 2 different ways because it can be helpful to think about things from a different angle.
