...
These are the same core requirements as P08, revised and polished based on conference guidance. See [P08](/course-ntw2029/assignments/papers/p2-p08-full-draft-and-outline-2520/) for detailed guidance on introduction structure, explanation and analysis integration, and significance discussion development.
