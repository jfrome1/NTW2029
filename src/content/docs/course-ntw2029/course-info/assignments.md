...
- Write your assignments in Google Docs, then download each one as a Word document (.docx) and submit that file on Canvas
...
- All paper prep assignments must be completed at minimum acceptable quality to pass the course [:what is minimum acceptable quality?](/course-ntw2029/course-info/grading/#x-what-is-minimum-acceptable-quality)
...
You can also read the [:full formatting details](#x-full-formatting-details) to set things manually.

### Additional Formatting Requirements for Drafts (P02, P07) and Final Papers (P03, P08)
