...
- revised Conference guidelines

2024-11-07

- fixed assignment name for Paper 2 proposal and revised source summary outline

2024-10-25

- posted Paper 2 proposal and revised source summary outline

2024-10-23

- added student groups to 10.2
- revised Canvas notification section of Tech Guidelines

2024-10-20

- added Resources → Writing → Analysis Questions

2024-10-17

- updated Conference guidelines page with instructions on solving MS Bookings time zone errors
- updated Exercise 10 link to workload template

2024-10-16

- removed non-working feedback form (blocked by NUS firewall), will rely on direct messages for website feedback

2024-10-12

- updated assignment links on Schedule
- added pages for Exercises 07-11

2024-10-10

- added pages for Paper 2 assignments
- reorganized information for all assignments
- updated schedule

2024-10-04

- added Mid-course feedback link to schedule
- added Paper 2 general topic proposal description

2024-10-03

- added Class Participation Survey link to schedule

2024-10-01

- added discussion questions for 7.2 reading

2024-09-27

- revised Assignments → Exercises → Exercise 4 to include example summaries of the assigned sections

2024-09-23

- added page Assignments → Exercises → Exercise 6
- fixed broken links on Course schedule

2024-09-22

- added page Assignments → Papers → Paper 1 final
- revised Paper 1 assignment
- revised in-text citations sections in Resources → Writing → Citations
- small revisions in Resources → Writing → Grammar
...
- revised/condensed [other policies](course-ntw2029/course-info/policies) page
- various wording revisions

2024-08-17

- added [:formatting policy](course-ntw2029/assignments/formatting)
- added [:extensions policy](course-ntw2029/course-info/extensions)
- simplified [exercise 10 - workload report](course-ntw2029/exercises/e10-workload) (still need to revise the actual workload log and link it for download)

2024-08-16

- added guidelines for course [exercises](course-ntw2029/exercises/ex-guidelines) and [conferences](course-ntw2029/general-info/conferences)
- added [grading criteria](course-ntw2029/course-info/grading) for class participation and exercises
- added [course policies](course-ntw2029/course-info/policies) for attendance, electronics, food and drink, talking in class, and feedback
- added [exercise 10 - workload report](course-ntw2029/exercises/e10-workload)
